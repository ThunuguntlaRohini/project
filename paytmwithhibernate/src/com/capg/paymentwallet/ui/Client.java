...
public class Client {
	...
	void deposit() throws Exception
	{
		...
		if(result){
			...
			System.out.println("\n\tMoney is NOT Deposited into "+ accountBean.getCustomerBean().getFirstName()+"'s Account\n\t ");
		}
	...
	void withdraw() throws Exception
	{
		...
		if(result){
			...
			System.out.print("\n\tMoney is NOT withdrawn from "+ accountBean.getCustomerBean().getFirstName()+"'s Account\n\t");
		}
	...
	void fundtransfer() throws Exception
	{
		...
		if(result){
			System.out.print("\n\tMoney is transferred  from "+ accountBean1.getCustomerBean().getFirstName()+"'s Account \n\t");
		}else{
			System.out.print("\n\tMoney is not transferred from "+ accountBean1.getCustomerBean().getFirstName()+"'s Account \n\t" );
		}
